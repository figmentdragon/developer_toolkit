...
if (!function_exists('creativity_custom_footer_scripts')) {
  function creativity_custom_footer_scripts() {
    global $creativity_blogpage_id;
    ?>
    <script type="text/javascript">
    <?php

		if (creativity_option('creativity_lazyload_iframe_banner') == true || creativity_option('creativity_lazyload_image_banner') == true ) { ?>
			/*! lazysizes - v5.2.2 */
    ...
    if (creativity_option('creativity_enable_custom_js')) {
      echo creativity_option('creativity_custom_js_code');
    }

    // include reading progressbar script
    if (creativity_option('creativity_reading_progress') == "yes" && is_single()) {
    ?>
  ...
  // sticky menu script
  if (creativity_cross_option('creativity_sticky_menu', $creativity_blogpage_id) == "yes") {
  	?>
    jQuery(document).ready( function() {
...
add_action( 'wp_footer', 'creativity_custom_footer_scripts' );
