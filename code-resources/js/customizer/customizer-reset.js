jQuery(function(s) {
    var e = [
        ["#customize-theme-controls", "all", "ct-reset", "ct-reset-main", creativityCustomizerReset.confirm, creativityCustomizerReset.reset]
    ];
    s.each(e, function(e, o) {
        ...
        c.on("click", function(e) {
            ...
            var t = {
                ...
                nonce: creativityCustomizerReset.nonce.reset,
                section: o[1]
            };
