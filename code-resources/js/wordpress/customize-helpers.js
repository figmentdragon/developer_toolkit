 ...
 */
function MYTHEMEGetHexLum( hex ) { // jshint ignore:line
	var rgb = MYTHEMEGetRgbFromHex( hex );
 ...
 */
function MYTHEMEGetRgbFromHex( hex ) {
	var shorthMYTHEMEgex = /^#?([a-f\d])([a-f\d])([a-f\d])$/i,
		result;

	// Expand shorthand form (e.g. "03F") to full form (e.g. "0033FF").
	hex = hex.replace( shorthMYTHEMEgex, function( m, r, g, b ) {
