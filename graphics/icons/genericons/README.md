...
If you keep intact the `-webkit-font-smoothing: antialiased;` and `` CSS properties. That'll make the icons look their best possible, in Firefox and WebKit based browsers.
