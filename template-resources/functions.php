...
function scrollme_admin_enqueue_scripts() {
    ...
    if( $currentScreen->id == "widgets" || $currentScreen->id == "page" ) {
        wp_enqueue_media();
        wp_enqueue_script( 'scrollme-media-uploader-js', get_template_directory_uri(). '/include/admin/js/media-uploader.js', array('jquery') );
    }

    wp_enqueue_style('scrollme-other-admin', get_template_directory_uri(). '/include/admin/css/other-admin.css');
}
 ...
 */
require get_template_directory() . '/include/extra-controls.php';
 ...
 */
require get_template_directory() . '/include/metabox.php';
 ...
 */
//require get_template_directory() . '/include/welcome/welcome-config.php';
