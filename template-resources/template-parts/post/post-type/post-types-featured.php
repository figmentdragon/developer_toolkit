...
$number = get_theme_mod( 'TheCreativityArchitect_featured_content_number', 3 );
...
for ( $i = 1; $i <= $number; $i++ ) {
	...
	$TheCreativityArchitect_post_id =  get_theme_mod( 'TheCreativityArchitect_featured_content_cpt_' . $i );
