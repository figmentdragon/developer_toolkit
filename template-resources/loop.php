<?php if (have_posts()): while (have_posts()) : the_post(); ?>
	...
	<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
		...
		<span class="comments"><?php if ( comments_open( get_the_ID() ) ) comments_popup_link( __( 'Leave your thoughts', 'creativitycore' ), __( '1 Comment', 'creativitycore' ), __( '% Comments', 'creativitycore' ) ); ?></span>
		<!-- /post details -->
