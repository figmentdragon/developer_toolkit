...
if ( ! function_exists( 'themename_get_defaults' ) ) {
	/**
	 * Set default options
	 *
	 */
	function themename_get_defaults() {
		$themename_defaults = array(
			'hide_title' => '',
			'hide_tagline' => true,
			'top_bar_width' => 'full',
		...
		return apply_filters( 'themename_option_defaults', $themename_defaults );
	}
}

if ( ! function_exists( 'themename_get_color_defaults' ) ) {
	/**
	 * Set default options
	 */
	function themename_get_color_defaults() {
		$themename_color_defaults = array(
			...
			'blog_header_bgthemename_color' => 'rgba(255,255,255,0)',
		...
		return apply_filters( 'themename_color_option_defaults', $themename_color_defaults );
	}
}
...
if ( ! function_exists( 'themename_get_default_fonts' ) ) {
	 ...
	 */
	function themename_get_default_fonts( $filter = true ) {
		$themename_font_defaults = array(
			'font_body' => 'Open Sans',
			'font_body_category' => '',
		...
		if ( $filter ) {
			return apply_filters( 'themename_font_option_defaults', $themename_font_defaults );
		}

		return $themename_font_defaults;
	}
}

if ( ! function_exists( 'themename_spacing_get_defaults' ) ) {
	/**
	 ...
	 * @return array Option defaults.
	 */
	function themename_spacing_get_defaults( $filter = true ) {
		$themename_spacing_defaults = array(
			'top_bar_top' => '5',
			'top_bar_right' => '40',
			'top_bar_bottom' => '2',
			'top_bar_left' => '40',
		...
		if ( $filter ) {
			return apply_filters( 'themename_spacing_option_defaults', $themename_spacing_defaults );
		}

		return $themename_spacing_defaults;
	}
}

if ( ! function_exists( 'themename_get_default_color_palettes' ) ) {
	/**
	 * Set up our colors for the color picker palettes and filter them so you can change them.
	 *
	 */
	function themename_get_default_color_palettes() {
		$palettes = array(
			'#fefefe',
			'#333333',
			'#585598',
		...
		return apply_filters( 'themename_default_color_palettes', $palettes );
	}
}

if ( ! function_exists( 'themename_typography_default_fonts' ) ) {
	/**
	 * Set the default system fonts.
	 *
	 */
	function themename_typography_default_fonts() {
		$fonts = array(
			'inherit',
			'System Stack',
		...
		return apply_filters( 'themename_typography_default_fonts', $fonts );
	}
}

define( 'themename_DEFAULT_FONTS' , '//fonts.googleapis.com/css?family=Kanit:100,100italic,200,200italic,300,300italic,regular,italic,500,500italic,600,600italic,700,700italic,800,800italic,900,900italic|Open+Sans:300,300italic,regular,italic,600,600italic,700,700italic,800,800italic|Nunito:200,200italic,300,300italic,regular,italic,600,600italic,700,700italic,800,800italic,900,900italic' );
