...
function upgrade_notice() {
	...
	$message = sprintf( esc_html__( 'THEMENAE requires at least WordPress version 5. You are running version %s. Please upgrade and try again.', 'TheThemeName' ), esc_attr($GLOBALS['wp_version'] ) );
...
function customize() {
	wp_die(
	/* translators: %s: version number */
		sprintf( esc_html__( 'THEMENAE requires at least WordPress version 5. You are running version %s. Please upgrade and try again.', 'TheThemeName' ), esc_attr($GLOBALS['wp_version'] )), '', array(
			'back_link' => true,
		)
	);
}
...
function preview() {
	if ( isset( $_GET['preview'] ) ) {
		/* translators: %s: version number */
		wp_die( sprintf( esc_html__( 'THEMENAE requires at least WordPress version 5. You are running version %s. Please upgrade and try again.', 'TheThemeName' ), esc_attr($GLOBALS['wp_version'] ) ) );
	}
}
