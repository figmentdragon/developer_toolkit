...
if ( ! function_exists( 'TheThemeNamesocial_bar' ) ) {
	add_action( 'TheThemeNamesocial_bar_action', 'TheThemeNamesocial_bar' );
	function TheThemeNamesocial_bar() {
		$socials_facebook_url  		=  TheThemeNameget_setting( 'socials_facebook_url' );
		$socials_twitter_url   		=  TheThemeNameget_setting( 'socials_twitter_url' );
		$socials_google_url    		=  TheThemeNameget_setting( 'socials_google_url' );
		$socials_tumblr_url    		=  TheThemeNameget_setting( 'socials_tumblr_url' );
		$socials_pinterest_url 		=  TheThemeNameget_setting( 'socials_pinterest_url' );
		$socials_youtube_url   		=  TheThemeNameget_setting( 'socials_youtube_url' );
		$socials_linkedin_url  		=  TheThemeNameget_setting( 'socials_linkedin_url' );
		$socials_custom_icon_1  	=  TheThemeNameget_setting( 'socials_custom_icon_1' );
		$socials_custom_icon_url_1  =  TheThemeNameget_setting( 'socials_custom_icon_url_1' );
		$socials_custom_icon_2  	=  TheThemeNameget_setting( 'socials_custom_icon_2' );
		$socials_custom_icon_url_2  =  TheThemeNameget_setting( 'socials_custom_icon_url_2' );
		$socials_custom_icon_3  	=  TheThemeNameget_setting( 'socials_custom_icon_3' );
		$socials_custom_icon_url_3  =  TheThemeNameget_setting( 'socials_custom_icon_url_3' );
		$socials_mail_url     		=  TheThemeNameget_setting( 'socials_mail_url' );
	?>
    <div class="TheThemeName-social-bar">
    	<ul class="TheThemeName-socials-list">
