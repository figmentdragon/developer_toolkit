...
class Breadcrumbs {
	...
	protected function set_labels() {
		...
		$defaults = array(
			'aria_label'          => esc_attr_x( 'Breadcrumbs', 'breadcrumbs aria label', 'TheThemeName' ),
			'home'                => esc_html__( 'Home', 'TheThemeName' ),
			'error_404'           => esc_html__( '404 Not Found', 'TheThemeName' ),
			'archives'            => esc_html__( 'Archives', 'TheThemeName' ),
			// Translators: %s is the search query.
			'search'              => esc_html__( 'Search results for: %s', 'TheThemeName' ),
			// Translators: %s is the page number.
			'paged'               => esc_html__( 'Page %s', 'TheThemeName' ),
			// Translators: %s is the page number.
			'paged_comments'      => esc_html__( 'Comment Page %s', 'TheThemeName' ),
			// Translators: Minute archive title. %s is the minute time format.
			'archive_minute'      => esc_html__( 'Minute %s', 'TheThemeName' ),
			// Translators: Weekly archive title. %s is the week date format.
			'archive_week'        => esc_html__( 'Week %s', 'TheThemeName' ),
