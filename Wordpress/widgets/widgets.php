 ...
 */
add_filter( 'dynamic_sidebar_params', 'themename_widget_classes' );

if ( ! function_exists( 'themename_widget_classes' ) ) {
	 ...
	 * @return array $params
	 */
	function themename_widget_classes( $params ) {
...
} // End of if function_exists( 'themename_widget_classes' ).
	...
	function themename_widgets_init() {
		register_sidebar(
			array(
				...
				'id'            => 'right-sidebar',
				'description'   => __( 'Right sidebar widget area', 'themename' ),
		...
		register_sidebar(
			array(
				'name'          => __( 'Left Sidebar', 'themename' ),
				'id'            => 'left-sidebar',
				'description'   => __( 'Left sidebar widget area', 'themename' ),
				'before_widget' => '<aside id="%1$s" class="widget %2$s">',
				'after_widget'  => '</aside>',
				'before_title'  => '<h3 class="widget-title">',
				'after_title'   => '</h3>',
		...
		register_sidebar(
			array(
				'name'          => __( 'Hero Slider', 'themename' ),
				'id'            => 'hero',
				'description'   => __( 'Hero slider area. Place two or more widgets here and they will slide!', 'themename' ),
		...
		register_sidebar(
			array(
				'name'          => __( 'Hero Canvas', 'themename' ),
				'id'            => 'herocanvas',
				'description'   => __( 'Full size canvas hero area for Bootstrap and other custom HTML markup', 'themename' ),
				'before_widget' => '',
				'after_widget'  => '',
				'before_title'  => '',
				'after_title'   => '',
		...
		register_sidebar(
			array(
				'name'          => __( 'Top Full', 'themename' ),
				'id'            => 'statichero',
				'description'   => __( 'Full top widget with dynamic grid', 'themename' ),
		...
		register_sidebar(
			array(
				'name'          => __( 'Footer Full', 'themename' ),
				'id'            => 'footerfull',
				'description'   => __( 'Full sized footer widget with dynamic grid', 'themename' ),
...
} // End of function_exists( 'themename_widgets_init' ).
