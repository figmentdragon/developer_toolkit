...
function themename_widgets_init() {
    ...
    register_sidebar(array(
        ...
        'description' => __('Sidebar appears next to content.', 'themename'),
    ...
    register_sidebar(array(
        'id' => 'call2action',
        'name' => __('Footer Call to Action', 'themename'),
        'description' => __('This "Call to Action" area appears after our content', 'themename'),
    ...
    register_sidebar(array(
        ...
        'description' => __('Newsletter widget appears in footer section on every page.', 'themename'),
    ...
    register_sidebar(array(
        ...
        'description' => __('Footer widget area', 'themename'),
