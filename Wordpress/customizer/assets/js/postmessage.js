(function ($) {
	...
	function setupStyleTag(id) {
		...
		tag.dataset.id = id;
		tag.className = 'customize-live-style';
	...
	wp.customize('page_max_width', function (value) {
		...
		value.bind(function (newval) {
			...
			styleTag.innerHTML = '.container, .boxed-layout .page {max-width: ' + newval + ';}';
		});
	});
	...
	wp.customize('page_boxed_margin', function (value) {
		value.bind(function (newval) {
			$('.page').css('margin-top', newval + 'px').css('margin-bottom', newval + 'px');
		});
	});
	...
	wp.customize('page_boxed_padding', function (value) {
		...
		value.bind(function (newval) {
			styleTag.innerHTML = '.container {padding-left: ' + newval + 'px; padding-right: ' + newval + 'px;}';
		});
	});
	...
	wp.customize('page_boxed_background', function (value) {
		...
		value.bind(function (newval) {
			styleTag.innerHTML = '.page {background-color: ' + newval + ';}';
		});
	});
	...
	wp.customize('404_headline', function (value) {
		value.bind(function (newval) {
			$('.404-content .entry-title').text(newval);
		});
	});

	wp.customize('404_text', function (value) {
		value.bind(function (newval) {
			$('.404-content p').text(newval);
		});
	});
	...
	wp.customize('menu_width', function (value) {
		...
		value.bind(function (newval) {
			newval = !newval ? '1200px' : newval;
			styleTag.innerHTML = '.nav-wrapper {max-width: ' + newval + ';}';
		});
	});
	...
	wp.customize('menu_height', function (value) {
		...
		value.bind(function (newval) {
			styleTag.innerHTML = '.nav-wrapper {padding-top: ' + newval + 'px; padding-bottom: ' + newval + 'px;}';
		});
	});
	...
	wp.customize('menu_padding', function (value) {
		...
		value.bind(function (newval) {
			styleTag.innerHTML = '.navigation .menu > .menu-item > a {padding-left: ' + newval + 'px; padding-right: ' + newval + 'px;}';
		});
	});
	...
	wp.customize('menu_bg_color', function (value) {
		...
		value.bind(function (newval) {
			styleTag.innerHTML = '.navigation:not(.navigation-transparent):not(.navigation-active) {background-color: ' + newval + ';}';
		});
	});
	...
	wp.customize('menu_font_color', function (value) {
		...
		value.bind(function (newval) {
			styleTag.innerHTML = '.navigation .menu a, .mobile-menu a, .close {color: ' + newval + ';}';
		});
	});
	...
	wp.customize('menu_font_color_alt', function (value) {
		...
		value.bind(function (newval) {
			styleTag.innerHTML = '\
				.navigation .menu a:hover, .mobile-menu a:hover {color: ' + newval + ';}\
				.navigation .menu > .current-menu-item > a, .mobile-menu > .current-menu-item > a {color: ' + newval + '!important;}\
			';
		});
	});
	...
	wp.customize('menu_font_size', function (value) {
		...
		value.bind(function (newval) {
			...
			styleTag.innerHTML = '.navigation .menu a, .mobile-menu a {font-size: ' + newval + suffix + ';}';
		});
	});
	...
	wp.customize('sub_menu_padding', function (value) {
		...
		value.bind(function (newval) {
			...
			styleTag.innerHTML = '\
				.sub-menu > .menu-item-has-children:not(.mega-menu) .sub-menu a {\
					padding-top: ' + top + 'px;\
	...
	wp.customize('sub_menu_width', function (value) {
		...
		value.bind(function (newval) {
			styleTag.innerHTML = '.sub-menu > .menu-item-has-children:not(.mega-menu) .sub-menu {width: ' + newval + 'px;}';
		});
	});
	...
	wp.customize('sub_menu_bg_color', function (value) {
		...
		value.bind(function (newval) {
			styleTag.innerHTML = '\
				.sub-menu > .menu-item-has-children:not(.mega-menu) .sub-menu li,\
	...
	wp.customize('sub_menu_bg_color_alt', function (value) {
		...
		value.bind(function (newval) {
			styleTag.innerHTML = '\
				.sub-menu > .menu-item-has-children:not(.mega-menu) .sub-menu li:hover {\
					background-color: ' + newval + ';\
				}\
			';
		});
	...
	wp.customize('sub_menu_accent_color', function (value) {
		...
		value.bind(function (newval) {
			styleTag.innerHTML = '.menu .sub-menu a {color: ' + newval + ';}';
		});
	});
	...
	wp.customize('sub_menu_accent_color_alt', function (value) {
		...
		value.bind(function (newval) {
			styleTag.innerHTML = '.navigation .menu .sub-menu a:hover {color: ' + newval + ';}';
		});
	});
	...
	wp.customize('sub_menu_font_size', function (value) {
		...
		value.bind(function (newval) {
			var suffix = $.isNumeric(newval) ? 'px' : '';
			styleTag.innerHTML = '.menu .sub-menu a {font-size: ' + newval + suffix + ';}';
		});
	});
	...
	wp.customize('sub_menu_separator_color', function (value) {
		...
		value.bind(function (newval) {
			styleTag.innerHTML = '.sub-menu > .menu-item-has-children:not(.mega-menu) li {border-bottom-color: ' + newval + ';}';
		});
	});
	...
	wp.customize('mobile_menu_height', function (value) {
		...
		value.bind(function (newval) {
			styleTag.innerHTML = '.mobile-nav-wrapper {padding-top: ' + newval + 'px; padding-bottom: ' + newval + 'px;}';
		});
	});
	...
	wp.customize('mobile_menu_background_color', function (value) {
		...
		value.bind(function (newval) {
			styleTag.innerHTML = '.mobile-nav-wrapper {background-color: ' + newval + ';}';
		});
	});
	...
	wp.customize('mobile_menu_hamburger_color', function (value) {
		...
		value.bind(function (newval) {
			styleTag.innerHTML = '.mobile-nav-item, .mobile-nav-item a {color: ' + newval + ';}';
		});
	});
	...
	wp.customize('mobile_menu_hamburger_size', function (value) {
		...
		value.bind(function (newval) {
			var suffix = $.isNumeric(newval) ? 'px' : '';
			styleTag.innerHTML = '.mobile-nav-item {font-size: ' + newval + suffix + ';}';
		});
	});
	...
	wp.customize('mobile_menu_hamburger_border_radius', function (value) {
		...
		value.bind(function (newval) {
			styleTag.innerHTML = '.mobile-nav-item {border-radius: ' + newval + 'px;}';
		});
	});
	...
	wp.customize('mobile_menu_bg_color', function (value) {
		...
		value.bind(function (newval) {
			styleTag.innerHTML = '.mobile-menu > .menu-item a {background-color: ' + newval + ';}';
		});
	});
	...
	wp.customize('mobile_menu_bg_color_alt', function (value) {
		...
		value.bind(function (newval) {
			styleTag.innerHTML = '.mobile-menu > .menu-item a:hover {background-color: ' + newval + ';}';
		});
	});
	...
	wp.customize('mobile_menu_font_color', function (value) {
		...
		value.bind(function (newval) {
			styleTag.innerHTML = '.mobile-menu a, .mobile-menu-container .close {color: ' + newval + ';}';
		});
	});
	...
	wp.customize('mobile_menu_font_color_alt', function (value) {
		...
		value.bind(function (newval) {
			styleTag.innerHTML = '.mobile-menu a:hover, .mobile-menu > .current-menu-item > a {color: ' + newval + '!important;}';
		});
	});
	...
	wp.customize('mobile_menu_border_color', function (value) {
		...
		value.bind(function (newval) {
			styleTag.innerHTML = '\
				.mobile-menu .menu-item {border-top-color: ' + newval + ';}\
				.mobile-menu > .menu-item:last-child {border-bottom-color: ' + newval + ';}\
			';
		});
	});
	...
	wp.customize('mobile_menu_submenu_arrow_color', function (value) {
		...
		value.bind(function (newval) {
			styleTag.innerHTML = '.submenu-toggle {color: ' + newval + ';}';
		});
	});
	...
	wp.customize('mobile_menu_font_size', function (value) {
		...
		value.bind(function (newval) {
			var suffix = $.isNumeric(newval) ? 'px' : '';
			styleTag.innerHTML = '.mobile-menu a, .mobile-menu .menu-item-has-children .submenu-toggle {font-size: ' + newval + suffix + ';}';
		});
	});
	...
	wp.customize('mobile_sub_menu_auto_collapse', function (value) {
		value.bind(function (newval) {
			...
			if (newval) {
				$('#mobile-navigation').closest('.navigation').addClass('mobile-sub-menu-auto-collapse');
			} else {
				$('#mobile-navigation').closest('.navigation').removeClass('mobile-sub-menu-auto-collapse');
			}
		});
	});
	...
	wp.customize('mobile_sub_menu_indent', function (value) {
		...
		value.bind(function (newval) {
			...
			styleTag.innerHTML = '.mobile-menu .sub-menu a {padding-left: ' + calculation + 'px;}';
		});
	});
	...
	wp.customize('mobile_sub_menu_bg_color', function (value) {
		...
		value.bind(function (newval) {
			styleTag.innerHTML = '.mobile-menu .sub-menu a {background-color: ' + newval + ';}';
		});
	});
	...
	wp.customize('mobile_sub_menu_bg_color_alt', function (value) {
		...
		value.bind(function (newval) {
			styleTag.innerHTML = '.mobile-menu .sub-menu a:hover {background-color: ' + newval + ';}';
		});
	});
	...
	wp.customize('mobile_sub_menu_font_color', function (value) {
		...
		value.bind(function (newval) {
			styleTag.innerHTML = '.mobile-menu .sub-menu a {color: ' + newval + ';}';
		});
	});
	...
	wp.customize('mobile_sub_menu_font_color_alt', function (value) {
		...
		value.bind(function (newval) {
			styleTag.innerHTML = '.mobile-menu .sub-menu a:hover, .mobile-menu .sub-menu > .current-menu-item > a {color: ' + newval + '!important;}';
		});
	});
	...
	wp.customize('mobile_sub_menu_border_color', function (value) {
		...
		value.bind(function (newval) {
			styleTag.innerHTML = '.mobile-menu .sub-menu .menu-item {border-top-color: ' + newval + ';}';
		});
	});
	...
	wp.customize('mobile_sub_menu_arrow_color', function (value) {
		...
		value.bind(function (newval) {
			styleTag.innerHTML = '.mobile-menu .sub-menu .submenu-toggle {color: ' + newval + ';}';
		});
	});
	...
	wp.customize('mobile_sub_menu_font_size', function (value) {
		...
		value.bind(function (newval) {
			var suffix = $.isNumeric(newval) ? 'px' : '';
			styleTag.innerHTML = '.mobile-menu .sub-menu a, .mobile-menu .sub-menu .menu-item-has-children .submenu-toggle {font-size: ' + newval + suffix + ';}';
		});
	});
	...
	wp.customize('menu_logo_size', function (value) {
		...
		value.bind(function (newval) {
			...
			styleTag.innerHTML = '\
				...
				@media (' + mediaQueries.tablet + ') {\
					.mobile-logo img {width: ' + tablet + tabletsuffix + ';}\
				}\
				@media (' + mediaQueries.mobile + ') {\
					.mobile-logo img {width: ' + mobile + mobilesuffix + ';}\
				}\
			';
	...
	wp.customize('menu_logo_font_size', function (value) {
		...
		value.bind(function (newval) {
			...
			styleTag.innerHTML = '\
				...
				@media (' + mediaQueries.tablet + ') {\
					.mobile-logo a {font-size: ' + tablet + tabletsuffix + ';}\
				}\
				@media (' + mediaQueries.mobile + ') {\
					.mobile-logo a {font-size: ' + mobile + mobilesuffix + ';}\
				}\
			';
	...
	wp.customize('menu_logo_color', function (value) {
		...
		value.bind(function (newval) {
			styleTag.innerHTML = '.logo a, .mobile-logo a {color: ' + newval + ';}';
		});
	});
	...
	wp.customize('menu_logo_color_alt', function (value) {
		...
		value.bind(function (newval) {
			styleTag.innerHTML = '.logo a:hover, .mobile-logo a:hover {color: ' + newval + ';}';
		});
	});
	...
	wp.customize('menu_logo_container_width', function (value) {
		...
		value.bind(function (newval) {
			...
			styleTag.innerHTML = '\
				.navigation .1-4 {width: ' + newval + '%;}\
				.navigation .3-4 {width: ' + calculation + '%;}\
			';
		});
	});
	...
	wp.customize('mobile_menu_logo_container_width', function (value) {
		...
		value.bind(function (newval) {
			...
			styleTag.innerHTML = '\
				@media (' + mediaQueries.tablet + ') {\
					.navigation .2-3 {width: ' + newval + '%;}\
					.navigation .1-3 {width: ' + calculation + '%;}\
				}\
			';
		});
	});
	...
	wp.customize('menu_logo_description_font_size', function (value) {
		...
		value.bind(function (newval) {
			...
			styleTag.innerHTML = '\
				.logo .tagline, .mobile-logo .tagline {\
					font-size: ' + desktop + desktopsuffix + ';\
				}\
				@media (' + mediaQueries.tablet + ') {\
					.mobile-logo .tagline {font-size: ' + tablet + tabletsuffix + ';}\
				}\
				@media (' + mediaQueries.mobile + ') {\
					.mobile-logo .tagline {font-size: ' + mobile + mobilesuffix + ';}\
				}\
			';
	...
	wp.customize('menu_logo_description_color', function (value) {
		...
		value.bind(function (newval) {
			styleTag.innerHTML = '.tagline {color: ' + newval + ';}';
		});
	});
	...
	wp.customize('pre_header_width', function (value) {
		...
		value.bind(function (newval) {
			newval = !newval ? '1200px' : newval;
			styleTag.innerHTML = '.inner-pre-header {max-width: ' + newval + ';}';
		});
	});
	...
	wp.customize('pre_header_height', function (value) {
		...
		value.bind(function (newval) {
			styleTag.innerHTML = '.inner-pre-header {padding-top: ' + newval + 'px; padding-bottom: ' + newval + 'px;}';
		});
	});
	...
	wp.customize('pre_header_bg_color', function (value) {
		...
		value.bind(function (newval) {
			styleTag.innerHTML = '.pre-header {background-color: ' + newval + ';}';
		});
	});
	...
	wp.customize('pre_header_font_color', function (value) {
		...
		value.bind(function (newval) {
			styleTag.innerHTML = '.pre-header {color: ' + newval + ';}';
		});
	});
	...
	wp.customize('pre_header_accent_color', function (value) {
		...
		value.bind(function (newval) {
			styleTag.innerHTML = '.pre-header a {color: ' + newval + ';}';
		});
	});
	...
	wp.customize('pre_header_accent_color_alt', function (value) {
		...
		value.bind(function (newval) {
			styleTag.innerHTML = '.pre-header a:hover, .pre-header .menu > .current-menu-item > a {color: ' + newval + '!important;}';
		});
	});
	...
	wp.customize('sidebar_width', function (value) {
		...
		value.bind(function (newval) {
			var calculation = 100 - newval;
			styleTag.innerHTML = '\
				.sidebar-wrapper {width: ' + newval + '%;}\
				.sidebar-left .main, .sidebar-right .main {width: ' + calculation + '%;}\
			';
		});
	});
	...
	wp.customize('sidebar_bg_color', function (value) {
		...
		value.bind(function (newval) {
			styleTag.innerHTML = '.sidebar .widget, .elementor-widget-sidebar .widget {background-color: ' + newval + ';}';
		});
	});
	...
	wp.customize('button_bg_color', function (value) {
		...
		value.bind(function (newval) {
			styleTag.innerHTML = '.button:not(.button-primary), input[type="submit"] {background-color: ' + newval + ';}';
		});
	});
	...
	wp.customize('button_bg_color_alt', function (value) {
		...
		value.bind(function (newval) {
			styleTag.innerHTML = '.button:not(.button-primary):hover, input[type="submit"]:hover {background-color: ' + newval + ';}';
		});
	});
	...
	wp.customize('button_text_color', function (value) {
		...
		value.bind(function (newval) {
			styleTag.innerHTML = '.button:not(.button-primary), input[type="submit"] {color: ' + newval + ';}';
		});
	});
	...
	wp.customize('button_text_color_alt', function (value) {
		...
		value.bind(function (newval) {
			styleTag.innerHTML = '.button:not(.button-primary):hover, input[type="submit"]:hover {color: ' + newval + ';}';
		});
	});
	...
	wp.customize('button_primary_bg_color', function (value) {
		...
		value.bind(function (newval) {
			styleTag.innerHTML = '\
				.button-primary {background-color: ' + newval + ';}\
				.button:not(.is-style-outline) .button__link:not(.has-background) {background-color: ' + newval + ';}\
				.is-style-outline .button__link:not(.has-text-color):not(.has-background) {border-color: ' + newval + '; color: ' + newval + ';}\
			';
		});
	});
	...
	wp.customize('button_primary_bg_color_alt', function (value) {
		...
		value.bind(function (newval) {
			styleTag.innerHTML = '\
				.button-primary:hover {background-color: ' + newval + ';}\
				.button:not(.is-style-outline) .button__link:not(.has-background):not(.has-text-color):hover {background-color: ' + newval + ';}\
				.is-style-outline .button__link:not(.has-text-color):not(.has-background):hover {border-color: ' + newval + '; color: ' + newval + ';}\
			';
		});
	});
	...
	wp.customize('button_primary_text_color', function (value) {
		...
		value.bind(function (newval) {
			styleTag.innerHTML = '\
				.button-primary {color: ' + newval + ';}\
				.button:not(.is-style-outline) .button__link:not(.has-text-color) {color: ' + newval + ';}\
			';
		});
	});
	...
	wp.customize('button_primary_text_color_alt', function (value) {
		...
		value.bind(function (newval) {
			styleTag.innerHTML = '\
				.button-primary:hover {color: ' + newval + ';}\
				.button:not(.is-style-outline) .button__link:not(.has-background):not(.has-text-color):hover {color: ' + newval + ';}\
			';
		});
	});
	...
	wp.customize('button_border_radius', function (value) {
		...
		value.bind(function (newval) {
			styleTag.innerHTML = '.button, input[type="submit"] {border-radius: ' + newval + 'px;}';
		});
	});
	...
	wp.customize('button_border_width', function (value) {
		...
		value.bind(function (newval) {
			styleTag.innerHTML = '.button, input[type="submit"] {border-width: ' + newval + 'px; border-style: solid;}';
		});
	});
	...
	wp.customize('button_border_color', function (value) {
		...
		value.bind(function (newval) {
			styleTag.innerHTML = '.button:not(.button-primary), input[type="submit"] {border-color: ' + newval + ';}';
		});
	});
	...
	wp.customize('button_border_color_alt', function (value) {
		...
		value.bind(function (newval) {
			styleTag.innerHTML = '.button:not(.button-primary):hover, input[type="submit"]:hover {border-color: ' + newval + ';}';
		});
	});
	...
	wp.customize('button_primary_border_color', function (value) {
		...
		value.bind(function (newval) {
			styleTag.innerHTML = '.button-primary {border-color: ' + newval + ';}';
		});
	});
	...
	wp.customize('button_primary_border_color_alt', function (value) {
		...
		value.bind(function (newval) {
			styleTag.innerHTML = '.button-primary:hover {border-color: ' + newval + ';}';
		});
	});
	...
	wp.customize('breadcrumbs_background_color', function (value) {
		...
		value.bind(function (newval) {
			styleTag.innerHTML = '.breadcrumbs-container {background-color: ' + newval + ';}';
		});
	});
	...
	wp.customize('breadcrumbs_alignment', function (value) {
		...
		value.bind(function (newval) {
			styleTag.innerHTML = '.breadcrumbs-container {text-align: ' + newval + ';}';
		});
	});
	...
	wp.customize('breadcrumbs_font_color', function (value) {
		...
		value.bind(function (newval) {
			styleTag.innerHTML = '.breadcrumbs {color: ' + newval + ';}';
		});
	});
	...
	wp.customize('breadcrumbs_accent_color', function (value) {
		...
		value.bind(function (newval) {
			styleTag.innerHTML = '.breadcrumbs a {color: ' + newval + ';}';
		});
	});
	...
	wp.customize('breadcrumbs_accent_color_alt', function (value) {
		...
		value.bind(function (newval) {
			styleTag.innerHTML = '.breadcrumbs a:hover {color: ' + newval + ';}';
		});
	});
	...
	wp.customize('footer_width', function (value) {
		...
		value.bind(function (newval) {
			newval = !newval ? '1200px' : newval;
			styleTag.innerHTML = '.inner-footer {max-width: ' + newval + ';}';
		});
	});
	...
	wp.customize('footer_height', function (value) {
		...
		value.bind(function (newval) {
			styleTag.innerHTML = '.inner-footer {padding-top: ' + newval + 'px; padding-bottom: ' + newval + 'px;}';
		});
	});
	...
	wp.customize('footer_bg_color', function (value) {
		...
		value.bind(function (newval) {
			styleTag.innerHTML = '.page-footer {background-color: ' + newval + ';}';
		});
	});
	...
	wp.customize('footer_font_color', function (value) {
		...
		value.bind(function (newval) {
			styleTag.innerHTML = '.inner-footer {color: ' + newval + ';}';
		});
	});
	...
	wp.customize('footer_accent_color', function (value) {
		...
		value.bind(function (newval) {
			styleTag.innerHTML = '.inner-footer a {color: ' + newval + ';}';
		});
	});
	...
	wp.customize('footer_accent_color_alt', function (value) {
		...
		value.bind(function (newval) {
			styleTag.innerHTML = '.inner-footer a:hover, .inner-footer .menu > .current-menu-item > a {color: ' + newval + ';}';
		});
	});
	...
	wp.customize('footer_font_size', function (value) {
		...
		value.bind(function (newval) {
			var suffix = $.isNumeric(newval) ? 'px' : '';
			styleTag.innerHTML = '.inner-footer, .inner-footer .menu {font-size: ' + newval + suffix + ';}';
		});
	});
	...
	wp.customize('woocommerce_menu_item_desktop_color', function (value) {
		...
		value.bind(function (newval) {
			styleTag.innerHTML = '\
				.menu .woo-menu-item .woo-menu-item-count {background-color: ' + newval + ';}\
			';
		});
	});
	...
	wp.customize('woocommerce_menu_item_mobile_color', function (value) {
		...
		value.bind(function (newval) {
			styleTag.innerHTML = '\
				.mobile-nav-wrapper .woo-menu-item .woo-menu-item-count {background-color: ' + newval + ';}\
			';
		});
	});
	...
	wp.customize('woocommerce_loop_image_alignment', function (value) {
		...
		value.bind(function (newval) {
			if (newval == 'left') {
				styleTag.innerHTML = '\
					.woo-list-view .woo-loop-thumbnail-wrapper {float: left;}\
					.woo-list-view .woo-loop-summary {float: right;}\
				';
			} else {
				styleTag.innerHTML = '\
					.woo-list-view .woo-loop-thumbnail-wrapper {float: right;}\
					.woo-list-view .woo-loop-summary {float: left;}\
				';
			}
		});
	});
	...
	wp.customize('woocommerce_loop_image_width', function (value) {
		...
		value.bind(function (newval) {
			styleTag.innerHTML = '\
				.woo-list-view .woo-loop-thumbnail-wrapper {width: ' + (newval - 2) + '%;}\
				.woo-list-view .woo-loop-summary {width: ' + (98 - newval) + '%;}\
			';
		});
	});
	...
	wp.customize('woocommerce_loop_out_of_stock_font_size', function (value) {
		...
		value.bind(function (newval) {
			var suffix = $.isNumeric(newval) ? 'px' : '';
			styleTag.innerHTML = '.woocommerce ul.products li.product .woo-loop-out-of-stock {font-size: ' + newval + suffix + ';}';
		});
	});
	...
	wp.customize('woocommerce_loop_out_of_stock_font_color', function (value) {
		...
		value.bind(function (newval) {
			styleTag.innerHTML = '.woocommerce ul.products li.product .woo-loop-out-of-stock {color: ' + newval + ';}';
		});
	});
	...
	wp.customize('woocommerce_loop_out_of_stock_background_color', function (value) {
		...
		value.bind(function (newval) {
			styleTag.innerHTML = '.woocommerce ul.products li.product .woo-loop-out-of-stock {background-color: ' + newval + ';}';
		});
	});
	...
	wp.customize('edd_menu_item_desktop_color', function (value) {
		...
		value.bind(function (newval) {
			styleTag.innerHTML = '\
				.menu .edd-menu-item .edd-menu-item-count {background-color: ' + newval + ';}\
			';
		});
	});
	...
	wp.customize('edd_menu_item_mobile_color', function (value) {
		...
		value.bind(function (newval) {
			styleTag.innerHTML = '\
				.mobile-nav-wrapper .edd-menu-item .edd-menu-item-count {background-color: ' + newval + ';}\
			';
		});
	});
