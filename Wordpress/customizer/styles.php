...
do_action( 'before_customizer_css' );

$breakpoint_mobile_int  = function_exists( 'breakpoint_mobile' ) ? breakpoint_mobile() : 480;
$breakpoint_medium_int  = function_exists( 'breakpoint_medium' ) ? breakpoint_medium() : 768;
$breakpoint_desktop_int = function_exists( 'breakpoint_desktop' ) ? breakpoint_desktop() : 1024;
...
$page_padding_top_desktop     = get_theme_mod_value( $page_padding, 'desktop_top' );
$page_padding_right_desktop   = get_theme_mod_value( $page_padding, 'desktop_right' );
$page_padding_bottom_desktop  = get_theme_mod_value( $page_padding, 'desktop_bottom' );
$page_padding_left_desktop    = get_theme_mod_value( $page_padding, 'desktop_left' );
$page_padding_top_tablet      = get_theme_mod_value( $page_padding, 'tablet_top' );
$page_padding_right_tablet    = get_theme_mod_value( $page_padding, 'tablet_right' );
$page_padding_bottom_tablet   = get_theme_mod_value( $page_padding, 'tablet_bottom' );
$page_padding_left_tablet     = get_theme_mod_value( $page_padding, 'tablet_left' );
$page_padding_top_mobile      = get_theme_mod_value( $page_padding, 'mobile_top' );
$page_padding_right_mobile    = get_theme_mod_value( $page_padding, 'mobile_right' );
$page_padding_bottom_mobile   = get_theme_mod_value( $page_padding, 'mobile_bottom' );
$page_padding_left_mobile     = get_theme_mod_value( $page_padding, 'mobile_left' );
...
if ( $button_border_width ) {
	...
	if ( $button_border_color_alt ) {
		...
		echo '.button:hover, input[type="submit"]:hover {';
...
if ( $button_primary_bg_color ) {
	...
	echo '.button__link:not(.has-background) {';
	echo sprintf( 'background: %s;', esc_attr( $button_primary_bg_color ) );
	echo '}';

	echo '.is-style-outline .button__link:not(.has-text-color) {';
...
if ( $button_primary_bg_color_alt || $button_primary_text_color_alt ) {
	...
	echo '.button:not(.is-style-outline) .button__link:not(.has-background):not(.has-text-color):hover {';
	...
	if ( $button_primary_bg_color_alt ) {
		echo '.is-style-outline .button__link:not(.has-text-color):not(.has-background):hover {';
...
if ( $page_width ) {
	...
	echo '.cover .cover__inner-container, .group .group__inner-container {';
	echo sprintf( 'max-width: %s;', esc_attr( $page_width ) );
	echo '}';
}
...
$sidebar_widget_padding_top_desktop    = get_theme_mod_value( $sidebar_widget_padding, 'desktop_top', 20 );
$sidebar_widget_padding_right_desktop  = get_theme_mod_value( $sidebar_widget_padding, 'desktop_right', 20 );
$sidebar_widget_padding_bottom_desktop = get_theme_mod_value( $sidebar_widget_padding, 'desktop_bottom', 20 );
$sidebar_widget_padding_left_desktop   = get_theme_mod_value( $sidebar_widget_padding, 'desktop_left', 20 );
$sidebar_widget_padding_top_tablet     = get_theme_mod_value( $sidebar_widget_padding, 'tablet_top', 20 );
$sidebar_widget_padding_right_tablet   = get_theme_mod_value( $sidebar_widget_padding, 'tablet_right', 20 );
$sidebar_widget_padding_bottom_tablet  = get_theme_mod_value( $sidebar_widget_padding, 'tablet_bottom', 20 );
$sidebar_widget_padding_left_tablet    = get_theme_mod_value( $sidebar_widget_padding, 'tablet_left', 20 );
$sidebar_widget_padding_top_mobile     = get_theme_mod_value( $sidebar_widget_padding, 'mobile_top', 20 );
$sidebar_widget_padding_right_mobile   = get_theme_mod_value( $sidebar_widget_padding, 'mobile_right', 20 );
$sidebar_widget_padding_bottom_mobile  = get_theme_mod_value( $sidebar_widget_padding, 'mobile_bottom', 20 );
$sidebar_widget_padding_left_mobile    = get_theme_mod_value( $sidebar_widget_padding, 'mobile_left', 20 );

if ( $sidebar_bg_color ) {

	echo '.sidebar .widget, .elementor-widget-sidebar .widget {';
...
if ( $sidebar_width ) {
	...
	echo 'body:not(.no-sidebar) .sidebar-wrapper.medium-1-3 {';
	echo sprintf( 'width: %s;', esc_attr( $sidebar_width ) . '%' );
	echo '}';

	echo 'body:not(.no-sidebar) .main.medium-2-3 {';
...
foreach ( $archives as $archive ) {
	...
	if ( $accent_color ) {
		...
		echo '.' . $archive . '-content .post a:not(.read-more) {';
	...
	if ( $accent_color_alt ) {
		...
		echo '.' . $archive . '-content .post a:not(.read-more):hover {';
	...
	if ( $title_size ) {
		...
		echo '.' . $archive . '-content .post .entry-title {';
	...
	if ( $font_size ) {
		...
		echo '.' . $archive . '-content .post .entry-summary {';
	...
	if ( 'plain' === $style && $space_between ) {
		...
		echo '.' . $archive . '-content .post-style-plain {';
	...
	if ( 'boxed' === $style ) {
		...
		if ( $background_color ) {
			...
			echo '.' . $archive . '-content .post-style-boxed {';
		...
		$boxed_padding_top_desktop    = get_theme_mod_value( $boxed_padding, 'desktop_top' );
		$boxed_padding_right_desktop  = get_theme_mod_value( $boxed_padding, 'desktop_right' );
		$boxed_padding_bottom_desktop = get_theme_mod_value( $boxed_padding, 'desktop_bottom' );
		$boxed_padding_left_desktop   = get_theme_mod_value( $boxed_padding, 'desktop_left' );
		$boxed_padding_top_tablet     = get_theme_mod_value( $boxed_padding, 'tablet_top' );
		$boxed_padding_right_tablet   = get_theme_mod_value( $boxed_padding, 'tablet_right' );
		$boxed_padding_bottom_tablet  = get_theme_mod_value( $boxed_padding, 'tablet_bottom' );
		$boxed_padding_left_tablet    = get_theme_mod_value( $boxed_padding, 'tablet_left' );
		$boxed_padding_top_mobile     = get_theme_mod_value( $boxed_padding, 'mobile_top' );
		$boxed_padding_right_mobile   = get_theme_mod_value( $boxed_padding, 'mobile_right' );
		$boxed_padding_bottom_mobile  = get_theme_mod_value( $boxed_padding, 'mobile_bottom' );
		$boxed_padding_left_mobile    = get_theme_mod_value( $boxed_padding, 'mobile_left' );
		...
		if ( $boxed_padding_top_desktop || $boxed_padding_right_desktop || $boxed_padding_bottom_desktop || $boxed_padding_left_desktop ) {
			...
			if ( $stretched && 'beside' !== $layout ) {
				...
				echo '.' . $archive . '-content .post-style-boxed.stretched .post-image-wrapper {';
				...
				echo '.' . $archive . '-content .post-style-boxed.stretched .article-header > .post-image-wrapper:first-child {';
	...
	if ( 'beside' === $layout ) {
		...
		if ( $image_width ) {
			...
			echo '.' . $archive . '-content .blog-layout-beside .large-2-5 {';
			echo sprintf( 'width: %s;', esc_attr( $image_width ) . '%' );
			echo '}';

			echo '.' . $archive . '-content .blog-layout-beside .large-3-5 {';
		...
		if ( $image_alignment ) {
			...
			echo '.' . $archive . '-content .blog-layout-beside .grid {';
...
$singles = apply_filters( 'singles', array( 'single' ) );
...
foreach ( $singles as $single ) {
	...
	if ( $custom_width ) {
		...
		echo '.single-' . $pt . ' .cover .cover__inner-container, .single-' . $pt . ' .group .group__inner-container {';
		echo sprintf( 'max-width: %s;', esc_attr( $custom_width ) );
		echo '}';
	...
	if ( $title_size ) {
		...
		echo '.' . $single . '-content .post .entry-title {';
		echo sprintf( 'font-size: %s;', esc_attr( $title_size ) . $suffix );
		echo '}';
	...
	if ( $font_size ) {
		...
		echo '.' . $single . '-content .post .entry-content {';
		echo sprintf( 'font-size: %s;', esc_attr( $font_size ) . $suffix );
		echo '}';
	...
	if ( 'boxed' === $style ) {
		...
		if ( $background_color ) {
			...
			echo '.' . $single . '-content .post-style-boxed .article-wrapper, .' . $single . '-content .post-style-boxed #respond {';
		...
		if ( $boxed_padding_top_desktop || $boxed_padding_right_desktop || $boxed_padding_bottom_desktop || $boxed_padding_left_desktop ) {
			...
			if ( $stretched ) {
				...
				echo '.' . $single . '-content .post-style-boxed.stretched .post-image-wrapper {';
				...
				echo '.' . $single . '-content .post-style-boxed.stretched .article-header > .post-image-wrapper:first-child {';
...
$menu_logo_font_size_desktop = get_theme_mod_value( $menu_logo_font_size, 'desktop', '22px' );
$menu_logo_font_size_tablet  = get_theme_mod_value( $menu_logo_font_size, 'tablet' );
$menu_logo_font_size_mobile  = get_theme_mod_value( $menu_logo_font_size, 'mobile' );
...
$menu_logo_size_desktop      = get_theme_mod_value( $menu_logo_size, 'desktop' );
$menu_logo_size_tablet       = get_theme_mod_value( $menu_logo_size, 'tablet' );
$menu_logo_size_mobile       = get_theme_mod_value( $menu_logo_size, 'mobile' );

if ( ! $custom_logo ) {

	if ( $menu_logo_font_toggle && $menu_logo_font_family_value ) {

		echo '.logo a, .mobile-logo a {';
	...
	if ( $menu_logo_color_alt ) {
		...
		echo '.logo a:hover, .mobile-logo a:hover {';
...
$menu_logo_description_font_size_desktop = get_theme_mod_value( $menu_logo_description_font_size, 'desktop' );
$menu_logo_description_font_size_tablet  = get_theme_mod_value( $menu_logo_description_font_size, 'tablet' );
$menu_logo_description_font_size_mobile  = get_theme_mod_value( $menu_logo_description_font_size, 'mobile' );
...
if ( $menu_padding ) {
	...
	echo '.navigation .menu > .menu-item > a {';
	...
	if ( 'menu-centered' === $menu_position ) {
		...
		echo '.menu-centered .logo-container {';
...
if ( $menu_bg_color ) {
	...
	echo '.navigation:not(.navigation-transparent):not(.navigation-active) {';
...
if ( $menu_font_color ) {
	...
	echo '.navigation .menu a, .mobile-menu a, .close {';
...
if ( $menu_font_color_alt ) {
	...
	echo '.navigation .menu a:hover, .mobile-menu a:hover {';
	echo sprintf( 'color: %s;', esc_attr( $menu_font_color_alt ) );
	echo '}';

	echo '.navigation .menu > .current-menu-item > a, .mobile-menu > .current-menu-item > a {';
...
if ( $menu_font_size ) {
	...
	echo '.navigation .menu a, .mobile-menu a {';
...
$sub_menu_padding_top      = get_theme_mod_value( $sub_menu_padding, 'top', 10 );
$sub_menu_padding_right    = get_theme_mod_value( $sub_menu_padding, 'right', 20 );
$sub_menu_padding_bottom   = get_theme_mod_value( $sub_menu_padding, 'bottom', 10 );
$sub_menu_padding_left     = get_theme_mod_value( $sub_menu_padding, 'left', 20 );
...
if ( $sub_menu_bg_color ) {
	...
	echo '.sub-menu > .menu-item-has-children:not(.mega-menu) .sub-menu li, .sub-menu > .mega-menu > .sub-menu {';
...
if ( $sub_menu_bg_color_alt ) {
	...
	echo '.sub-menu > .menu-item-has-children:not(.mega-menu) .sub-menu li:hover {';
...
if ( $sub_menu_separator ) {
	...
	echo '.sub-menu > .menu-item-has-children:not(.mega-menu) li {';
	...
	echo '.sub-menu > .menu-item-has-children:not(.mega-menu) li:last-child {';
...
if ( $sub_menu_width ) {
	...
	echo '.sub-menu > .menu-item-has-children:not(.mega-menu) .sub-menu {';
...
if ( $sub_menu_padding_top || $sub_menu_padding_right || $sub_menu_padding_bottom || $sub_menu_padding_left ) {
	...
	echo '.sub-menu > .menu-item-has-children:not(.mega-menu) .sub-menu a {';
...
if ( $sub_menu_accent_color || $sub_menu_font_size ) {
	...
	echo '.navigation .menu .sub-menu a {';
...
if ( $sub_menu_accent_color_alt ) {
	...
	echo '.navigation .menu .sub-menu a:hover {';
...
$mobile_menu_padding_top             = get_theme_mod_value( $mobile_menu_padding, 'top', 10 );
$mobile_menu_padding_right           = get_theme_mod_value( $mobile_menu_padding, 'right', 20 );
$mobile_menu_padding_bottom          = get_theme_mod_value( $mobile_menu_padding, 'bottom', 10 );
$mobile_menu_padding_left            = get_theme_mod_value( $mobile_menu_padding, 'left', 20 );
...
if ( $mobile_menu_padding_top || $mobile_menu_padding_right || $mobile_menu_padding_bottom || $mobile_menu_padding_left ) {
	...
	echo '.mobile-menu a, .mobile-menu .menu-item-has-children .submenu-toggle {';
...
if ( $mobile_menu_font_color ) {
	...
	echo '.mobile-menu a, .mobile-menu-container .close {';
...
if ( $mobile_menu_font_color_alt ) {
	...
	echo '.mobile-menu > .current-menu-item > a {';
...
if ( $mobile_menu_bg_color_alt ) {
	...
	echo '.mobile-menu > .menu-item a:hover {';
...
if ( $mobile_menu_submenu_arrow_color ) {
	...
	echo '.mobile-menu .submenu-toggle {';
...
if ( $mobile_sub_menu_bg_color_alt ) {
	...
	echo '.mobile-menu .sub-menu a:hover {';
...
if ( $mobile_sub_menu_arrow_color ) {
	...
	echo '.mobile-menu .sub-menu .submenu-toggle {';
...
if ( $mobile_sub_menu_font_size ) {
	...
	echo '.mobile-menu .sub-menu a, .mobile-menu .sub-menu .menu-item-has-children .submenu-toggle {';
...
if ( $mobile_sub_menu_font_color_alt ) {
	...
	echo '.mobile-menu .sub-menu > .current-menu-item > a {';
...
if ( $mobile_sub_menu_border_color ) {
	...
	echo '.mobile-menu .sub-menu .menu-item {';
...
if ( 'none' !== $pre_header_layout && $pre_header_accent_color_alt ) {
	...
	echo '.pre-header a:hover {';
	echo sprintf( 'color: %s;', esc_attr( $pre_header_accent_color_alt ) );
	echo '}';

	echo '.pre-header .menu > .current-menu-item > a {';
...
if ( 'none' !== $pre_header_layout && $pre_header_font_size ) {
	...
	echo '.pre-header, .pre-header .menu, .pre-header .menu .sub-menu a {';
...
if ( 'none' !== $footer_layout && $footer_accent_color_alt ) {
	...
	echo '.inner-footer a:hover {';
	echo sprintf( 'color: %s;', esc_attr( $footer_accent_color_alt ) );
	echo '}';

	echo '.inner-footer .menu > .current-menu-item > a {';
...
if ( 'none' !== $footer_layout && $footer_font_size ) {
	...
	echo '.inner-footer, .inner-footer .menu {';
	echo sprintf( 'font-size: %s;', esc_attr( $footer_font_size ) . $suffix );
	echo '}';

}

do_action( 'after_customizer_css' );
