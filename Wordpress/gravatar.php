...
function get_local_gravatar( $url ) {
	...
	$pbf_dir    = $upload_dir['basedir'] . '/THEMENAE/';
	$avatar_dir = $upload_dir['basedir'] . '/THEMENAE/gravatar/';
	$avatar_url = $upload_dir['baseurl'] . '/THEMENAE/gravatar/';

	// Create THEMENAE folder if it doesn't exist.
