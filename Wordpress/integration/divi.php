 ...
 */
function divi_default_headline_styles() {
	...
	$inline_styles = minify_css( $inline_styles );

	wp_add_inline_style( 'et-builder-modules-style', $inline_styles );

}
// add_action( 'wp_enqueue_scripts', 'divi_default_headline_styles', 999 );
 ...
 */
function divi_theme_builder_custom_header( $layout_id, $layout_enabled, $template_id ) {
...
add_action( 'et_theme_builder_template_before_header', 'divi_theme_builder_custom_header', 10, 3 );
 ...
 * @param int $template_id The template ID
 */
function divi_theme_builder_custom_footer( $layout_id, $layout_enabled, $template_id ) {
...
add_action( 'et_theme_builder_template_after_footer', 'divi_theme_builder_custom_footer', 10, 3 );
