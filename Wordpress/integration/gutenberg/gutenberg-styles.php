...
$page_font_size_desktop = get_theme_mod_value( $page_font_size, 'desktop', '16px' );
...
if ( $page_font_color ) {
	...
	echo '#wpwrap .editor-styles-wrapper, .code .block-editor-plain-text, .preformatted pre, .quote__citation, .pullquote .pullquote__citation, .verse pre, pre.verse {';
	echo sprintf( 'color: %s;', esc_attr( $page_font_color ) );
	echo '}';
...
$page_h1_font_size_desktop = get_theme_mod_value( $page_h1_font_size, 'desktop', '32px' );
...
$page_h2_font_size_desktop = get_theme_mod_value( $page_h2_font_size, 'desktop', '28px' );
...
$page_h3_font_size_desktop = get_theme_mod_value( $page_h3_font_size, 'desktop', '24px' );
...
$page_h4_font_size_desktop = get_theme_mod_value( $page_h4_font_size, 'desktop', '20px' );
...
$page_h5_font_size_desktop = get_theme_mod_value( $page_h5_font_size, 'desktop', '16px' );
...
$page_h6_font_size_desktop = get_theme_mod_value( $page_h6_font_size, 'desktop', '16px' );
