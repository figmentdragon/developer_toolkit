...
function do_woocommerce_customizer_css() {
	...
	if ( 'hide' !== $woocommerce_menu_item_desktop ) {
		...
		if ( $woocommerce_menu_item_desktop_color ) {
			...
			echo '.menu .woo-menu-item .woo-menu-item-count {';
	...
	if ( 'hide' !== $woocommerce_menu_item_mobile ) {
		...
		if ( $woocommerce_menu_item_mobile_color ) {
			...
			echo '.mobile-nav-wrapper .woo-menu-item .woo-menu-item-count {';
	...
	if ( 'list' === $woocommerce_loop_layout ) {
		...
		echo '.woo-list-view .woo-loop-thumbnail-wrapper {';
		echo 'float: left;';
		echo 'width: 48%;';
		echo '}';

		echo '.woo-list-view .woo-loop-summary {';
		echo 'float: right;';
		echo 'width: 48%;';
		echo '}';

		echo '.woo-list-view.woocommerce ul.products li.product a img, .woo-list-view ul.products li.product a img {';
	...
	if ( $woocommerce_loop_out_of_stock_font_size || $woocommerce_loop_out_of_stock_font_color || $woocommerce_loop_out_of_stock_background_color ) {
		...
		echo '.woocommerce ul.products li.product .woo-loop-out-of-stock {';
...
add_action( 'after_customizer_css', 'do_woocommerce_customizer_css', 10 );
