...
function woo_sidebar() {
	...
	register_sidebar(
		array(
			...
			'name'          => __( 'WooCommerce Sidebar', 'TheThemeName' ),
			'before_widget' => '<div id="%1$s" class="widget %2$s">',
			'after_widget'  => '</div>',
			'before_title'  => '<h4 class="widgettitle">',
			'after_title'   => '</h4>',
			'description'   => __( 'Widgets in this area will be shown on WooCommerce archive pages.', 'TheThemeName' ),
		)
	);
	...
	register_sidebar(
		array(
			...
			'name'          => __( 'WooCommerce Product Page Sidebar', 'TheThemeName' ),
			'before_widget' => '<div id="%1$s" class="widget %2$s">',
			'after_widget'  => '</div>',
			'before_title'  => '<h4 class="widgettitle">',
			'after_title'   => '</h4>',
			'description'   => __( 'Widgets in this area will be shown on WooCommerce product pages.', 'TheThemeName' ),
		)
	);
...
function woo_loop_out_of_stock() {
	...
	if ( ! $out_of_stock_notice || 'hide' !== $out_of_stock_notice ) {
		...
		$out_of_stock_string = apply_filters( 'woo_loop_out_of_stock_string', __( 'Out of stock', 'TheThemeName' ) );
...
function woo_menu_item( $markup = 'li' ) {
	...
	$title       = apply_filters( 'woo_menu_item_title', __( 'Shopping Cart', 'TheThemeName' ) );
	...
	if ( 'hide' !== get_theme_mod( 'woocommerce_menu_item_count' ) ) {
		$menu_item .= '<span class="woo-menu-item-count">' . wp_kses_data( $cart_count ) . '<span class="screen-reader-text">' . __( 'Items in Cart', 'TheThemeName' ) . '</span></span>';
	}
...
function woo_before_quantity_input_field() {
	...
	<button type="button" class="qty-control qty-decrease">
		<span class="screen-reader-text"><?php _e( 'Decrease quantity', 'TheThemeName' ); ?></span>
	</button>
...
function woo_after_quantity_input_field() {
	...
	<button type="button" class="qty-control qty-increase">
		<span class="screen-reader-text"><?php _e( 'Increase quantity', 'TheThemeName' ); ?></span>
	</button>
