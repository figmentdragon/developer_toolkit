...
function do_edd_customizer_css() {
	...
	if ( 'hide' !== $edd_menu_item_desktop ) {
		...
		if ( $edd_menu_item_desktop_color ) {
			...
			echo '.menu .edd-menu-item .edd-menu-item-count {';
	...
	if ( 'hide' !== $edd_menu_item_mobile ) {
		...
		if ( $edd_menu_item_mobile_color ) {
			...
			echo '.mobile-nav-wrapper .edd-menu-item .edd-menu-item-count {';
...
add_action( 'after_customizer_css', 'do_edd_customizer_css', 10 );
