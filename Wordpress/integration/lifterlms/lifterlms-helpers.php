 ...
 * Hex to rgb.
 */
function lifterlms_hex_to_rgb( $hex ) {
 ...
 * Adjust hex.
 */
function lifterlms_adjust_hex( $hex, $percent ) {

	$rgb = lifterlms_hex_to_rgb( $hex );
	$new_hex = '#';
 ...
 * Get luminance.
 */
function lifterlms_get_luminance( $hex ) {
