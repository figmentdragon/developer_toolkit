...
add_action( 'wp_head', 'scrollme_customizer_css' );
add_action( 'customize_controls_enqueue_scripts', 'scrollme_customize_scripts' );
add_action( 'customize_register', 'scrollme_include_custom_controls', -999 );
add_action( 'customize_register', 'scrollme_remove_default_customizer_sections', 15 );
add_action( 'customize_preview_init', 'scrollme_customize_preview_js' );
add_action( 'customize_controls_enqueue_scripts', 'scrollme_customize_controls_js' );
add_action( 'customize_register', 'scrollme_customize_register' );
add_action( 'customize_register', 'scrollme_selective_refresh_support' );
add_action( 'customize_register', 'scrollme_live_preview_support', 999 );


 function scrollme_remove_default_customizer_sections( $wp_customize ) {
...
function scrollme_include_custom_controls() {
...
function scrollme_customize_preview_js() {
 	wp_enqueue_script( 'scrollme_customizer', get_template_directory_uri() . '/inc/customizer/assets/scripts/customizer.js', array( 'customize-preview' ), '20130508', true );
}

function scrollme_selective_refresh_support( $wp_customize ) {
  // The <div> classname to append edit icon too.
 	$settings = [
 		'blogname'          => '.site-title a',
 		'blogdescription'   => '.site-description',
 		'scrollme_copyright_text' => '.site-info',
 	];
 ...
 function scrollme_live_preview_support( $wp_customize ) {
...
function scrollme_customize_controls_js() {
  wp_enqueue_script( 'scrollme_customizer', get_template_directory_uri() . '/assets/js/customizer-controls.js', array( 'customize-preview' ), '20130508', true );
}
...
/*----------------------------------------------------------------------------*/
	...
	$wp_customize->add_control( new WP_Customize_Image_Control(
		$wp_customize, 'scrollme_home_logo',
			array(
  ...
  $wp_customize->add_setting( 'scrollme_tpl_color', array( 'sanitize_callback' => 'sanitize_hex_color', 'default' => '#df2c45' ) );
	...
	// General Settings
	$wp_customize->add_panel( 'scrollme_panel_general_settings',
		array(
	...
	// General Section
	$wp_customize->add_section( 'scrollme_section_preloader',
		array(
	...
	// Preloader
	$wp_customize->add_setting( 'scrollme_preloader',
		array(
			'sanitize_callback' => 'scrollme_sanitize_checkbox'
		)
	);

	$wp_customize->add_control( 'scrollme_preloader',
		array(
			'type' => 'checkbox',
	...
	$wp_customize->add_setting( 'scrollme_blog_page',
		array(
			'default' => '0',
	...
	$wp_customize->add_control( new scrollme_Category_Dropdown_Control(
		$wp_customize, 'scrollme_blog_page',
			array(
	...
	$wp_customize->add_setting( 'scrollme_section_home',
		array(
			'default' => 'home',
			'capability' => 'edit_theme_options',
	...
	$wp_customize->add_setting( 'scrollme_slider_category',
		array(
			'default' => '0',
			'capability' => 'edit_theme_options',
	...
	// Slider Pause
	$wp_customize->add_setting( 'scrollme_slider_pause',
		array(
			'default' => '4000',
			'capability' => 'edit_theme_options',
			'sanitize_callback' => 'scrollme_sanitize_integer'
	...
	$wp_customize->add_control( 'scrollme_slider_pause',
		array(
	...
	// Slider Caption
	$wp_customize->add_setting( 'scrollme_slider_caption',
		array(
			'default' => 'yes',
			'sanitize_callback' => 'scrollme_sanitize_slider_settings'
		)
	);
	$wp_customize->add_control( 'scrollme_slider_caption',
		array(
	...
	$wp_customize->add_setting( 'scrollme_disp_caption_in_mobile',
    array(
      'default' => 0,
      'sanitize_callback' => 'absint'));
	$wp_customize->add_control( 'scrollme_disp_caption_in_mobile',
		array(
	...
	// Section 1
	$wp_customize->add_section( 'scrollme_sec_1',
		array(
	...
	$wp_customize->add_setting( 'scrollme_section_1_disable',
    array(
      'default' => '', 'capability' => 'edit_theme_options', 'sanitize_callback' => 'absint' ));
  ...
  $wp_customize->add_setting( 'scrollme_section_layout1',
    array(
      'default' => 'services',
      'capability' => 'edit_theme_options',
      'sanitize_callback' => 'sanitize_text_field' )
    );
	$wp_customize->add_control( 'scrollme_section_layout1',
		array(
	...
	$wp_customize->add_control( 'scrollme_section_3_disable',
		array(
			'label'	=> __( 'Disable Section', 'scrollme' ),
			'type' => 'checkbox',
	...
	$wp_customize->add_setting( 'scrollme_section_3',
    array(
      'default' => 'section-3',
      'capability' => 'edit_theme_options',
      'sanitize_callback' => 'sanitize_title_with_dashes'
    ));
	$wp_customize->add_control( 'scrollme_section_3',
		array(
			'label'	=> __( 'ID for Navigation', 'scrollme' ),
			'type' => 'text',
			'section' => 'scrollme_sec_3',
  ...
  $wp_customize->add_setting( 'scrollme_section_3_type', array( 'default' => 'page', 'capability' => 'edit_theme_options', 'sanitize_callback' => 'sanitize_text_field' ));
    ...
    $wp_customize->add_setting( 'scrollme_blog_cat',
			array(
			 	'default' => '0',
				'capability' => 'edit_theme_options',
				'sanitize_callback' => 'scrollme_sanitize_integer'
		...
		$wp_customize->add_control( new scrollme_Category_Dropdown_Control(
		 $wp_customize, 'scrollme_blog_cat',
		 	array(
				'label' => __( 'Choose Category for Blog', 'scrollme' ),
				'section' => 'scrollme_blog_settings',
    ...
    $wp_customize->add_setting( 'scrollme_blog_readmore_txt',
			array(
				'default' => "Read More",
				'capability' => 'edit_theme_options',
				'sanitize_callback' => 'sanitize_text_field'
    ...
    $wp_customize->add_control( 'scrollme_blog_readmore_txt',
			array(
    ...
    $wp_customize->add_setting( 'scrollme_sicon_info',
			array(
				'sanitize_callback' => 'sanitize_text_field'
			)
		);
    $wp_customize->add_control( new WP_Customize_Help_Control(
			$wp_customize, 'scrollme_sicon_info',
				array(
	...
	$wp_customize->add_setting( 'scrollme_metadata_disable',
		array(
			'default' => 1,
			'capability' => 'edit_theme_options',
			'sanitize_callback' => 'absint'
	...
	$wp_customize->add_control( 'scrollme_metadata_disable',
		array(
	...
	$wp_customize->add_section(
		'scrollme_theme_layout_options',
		array(
			'title'       => __( 'Theme Layout Settings', 'scrollme' ),
			'capability'  => 'edit_theme_options',
			'description' => __( 'Container width and sidebar defaults', 'scrollme' ),
			'priority'    => apply_filters( 'scrollme_theme_layout_options_priority', 160 ),
		)
	);

	$wp_customize->add_setting(
		'scrollme_bootstrap_version',
		array(
			'default'           => 'bootstrap4',
			'type'              => 'theme_mod',
			'sanitize_callback' => 'sanitize_text_field',
	...
	$wp_customize->add_control(
		new WP_Customize_Control(
			...
			'scrollme_bootstrap_version',
			array(
				'label'       => __( 'Bootstrap Version', 'scrollme' ),
				'description' => __( 'Choose between Bootstrap 4 or Bootstrap 5', 'scrollme' ),
				'section'     => 'scrollme_theme_layout_options',
				'settings'    => 'scrollme_bootstrap_version',
				'type'        => 'select',
				'choices'     => array(
					'bootstrap4' => __( 'Bootstrap 4', 'scrollme' ),
					'bootstrap5' => __( 'Bootstrap 5', 'scrollme' ),
				),
				'priority'    => apply_filters( 'scrollme_bootstrap_version_priority', 10 ),
			)
		)
	);

	$wp_customize->add_setting(
		'scrollme_container_type',
		array(
			'default'           => 'container',
			'type'              => 'theme_mod',
			'sanitize_callback' => 'scrollme_theme_slug_sanitize_select',
			'capability'        => 'edit_theme_options',
		)
	);
	...
	$wp_customize->add_control(
		new WP_Customize_Control(
			...
			'scrollme_container_type',
			array(
				'label'       => __( 'Container Width', 'scrollme' ),
				'description' => __( 'Choose between Bootstrap\'s container and container-fluid', 'scrollme' ),
				'section'     => 'scrollme_theme_layout_options',
				'settings'    => 'scrollme_container_type',
				'type'        => 'select',
				'choices'     => array(
					'container'       => __( 'Fixed width container', 'scrollme' ),
					'container-fluid' => __( 'Full width container', 'scrollme' ),
				),
				'priority'    => apply_filters( 'scrollme_container_type_priority', 10 ),
			)
		)
	);

	$wp_customize->add_setting(
		'scrollme_navbar_type',
		array(
			'default'           => 'collapse',
			'type'              => 'theme_mod',
			'sanitize_callback' => 'sanitize_text_field',
	...
	$wp_customize->add_control(
		new WP_Customize_Control(
			...
			'scrollme_navbar_type',
			array(
				'label'             => __( 'Responsive Navigation Type', 'scrollme' ),
				'description'       => __(
					'Choose between an expanding and collapsing navbar or an offcanvas drawer.',
					'scrollme'
				),
				'section'           => 'scrollme_theme_layout_options',
				'settings'          => 'scrollme_navbar_type',
				'type'              => 'select',
				'sanitize_callback' => 'scrollme_theme_slug_sanitize_select',
				'choices'           => array(
					'collapse'  => __( 'Collapse', 'scrollme' ),
					'offcanvas' => __( 'Offcanvas', 'scrollme' ),
				),
				'priority'          => apply_filters( 'scrollme_navbar_type_priority', 20 ),
			)
		)
	);

	$wp_customize->add_setting(
		'scrollme_sidebar_position',
		array(
			'default'           => 'right',
			'type'              => 'theme_mod',
			'sanitize_callback' => 'sanitize_text_field',
	...
	$wp_customize->add_control(
		new WP_Customize_Control(
			...
			'scrollme_sidebar_position',
			array(
				'label'             => __( 'Sidebar Positioning', 'scrollme' ),
				'description'       => __(
					'Set sidebar\'s default position. Can either be: right, left, both or none. Note: this can be overridden on individual pages.',
					'scrollme'
				),
				'section'           => 'scrollme_theme_layout_options',
				'settings'          => 'scrollme_sidebar_position',
				'type'              => 'select',
				'sanitize_callback' => 'scrollme_theme_slug_sanitize_select',
				'choices'           => array(
					'right' => __( 'Right sidebar', 'scrollme' ),
					'left'  => __( 'Left sidebar', 'scrollme' ),
					'both'  => __( 'Left & Right sidebars', 'scrollme' ),
					'none'  => __( 'No sidebar', 'scrollme' ),
				),
				'priority'          => apply_filters( 'scrollme_sidebar_position_priority', 20 ),
			)
		)
	);

	$wp_customize->add_setting(
		'scrollme_site_info_override',
		array(
			'default'           => '',
			'type'              => 'theme_mod',
	...
	$wp_customize->add_control(
		new WP_Customize_Control(
			...
			'scrollme_site_info_override',
			array(
				'label'       => __( 'Footer Site Info', 'scrollme' ),
				'description' => __( 'Override scrollme\'s site info located at the footer of the page.', 'scrollme' ),
				'section'     => 'scrollme_theme_layout_options',
				'settings'    => 'scrollme_site_info_override',
				'type'        => 'textarea',
				'priority'    => 20,
			)
		)
	...
	$wp_customize->add_section(
		'scrollme_theme_options',
		array(
			'title'    => esc_html__( 'Theme Options', 'scrollme' ),
			'priority' => 125,
		)
	);
	...
	$wp_customize->add_control(
		'copyright_text',
		array(
			'label'   => esc_html__( 'Add copyright text in the footer.', 'scrollme' ),
			'section' => 'scrollme_theme_options',
			'type'    => 'textarea',
		)
	);
	...
	$wp_customize->add_control(
		new WP_Customize_Color_Control(
			...
			'text-color',
			array(
				'label'    => esc_html__( 'General text color', 'scrollme' ),
				'section'  => 'colors',
				'settings' => 'text-color',
				'priority' => 8,
			)
	...
	$wp_customize->add_control(
		new WP_Customize_Color_Control(
			...
			'menu-links',
			array(
				'label'    => esc_html__( 'Menu links', 'scrollme' ),
				'section'  => 'colors',
				'settings' => 'menu-links',
				'priority' => 10,
			)
	...
	$wp_customize->add_control(
		new WP_Customize_Color_Control(
			...
			'secondary-color',
			array(
				'label'    => esc_html__( 'Change the theme red color throughout', 'scrollme' ),
				'section'  => 'colors',
	...
	$wp_customize->add_control(
		new WP_Customize_Color_Control(
			...
			'title-color',
			array(
				'label'    => esc_html__( 'Titles color', 'scrollme' ),
				'section'  => 'colors',
...
function scrollme_customizer_css() {
	?>
	<style type="text/css">
		body {
...
function scrollme_theme_slug_sanitize_select( $input, $setting ) {
...
function scrollme_default_navbar_type( $current_mod ) {
	if ( 'bootstrap5' !== get_theme_mod( 'scrollme_bootstrap_version' ) ) { $current_mod = 'collapse'; } return $current_mod;
}
add_filter( 'theme_mod_scrollme_navbar_type', 'scrollme_default_navbar_type', 20 );
