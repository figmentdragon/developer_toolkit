...
function theme_support() {
	...
	register_nav_menus(
		array(
			'main-nav' => __( 'The Main Menu', 'TheThemeName' ),   // main nav in header
			'footer-links' => __( 'Footer Links', 'TheThemeName' ) // secondary nav in footer
		)
	);
...
function related_posts() {
	...
	if($tags) {
		...
		if($related_posts) {
			...
			<?php echo '<li class="no_related_post">' . __( 'No Related Posts Yet!', 'TheThemeName' ) . '</li>'; ?>
		<?php }
	}
	wp_reset_postdata();
	echo '</ul>';
